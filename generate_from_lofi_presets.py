...
_BASE_LOFI_PROMPT_BANK: tuple[str, ...] = (
    # Rain & weather (1–15)
...
_ADHD_FOCUS_PROMPT_OPENERS: tuple[str, ...] = (
    # Rain & weather (1-15)
    "ambient ADHD music for focus and work, instrumental lofi, rain-muted attention bed",
    "ambient ADHD music for focus and work, instrumental lofi, thunder-soft concentration drift",
    "ambient ADHD music for focus and work, instrumental lofi, cozy drizzle task flow",
    "ambient ADHD music for focus and work, instrumental lofi, monsoon calm desk rhythm",
    "ambient ADHD music for focus and work, instrumental lofi, window-rain focus cushion",
    "ambient ADHD music for focus and work, instrumental lofi, midnight rain deep-work pad",
    "ambient ADHD music for focus and work, instrumental lofi, rainy trumpet attention glow",
    "ambient ADHD music for focus and work, instrumental lofi, grey-morning steady workspace",
    "ambient ADHD music for focus and work, instrumental lofi, soft-season planning loop",
    "ambient ADHD music for focus and work, instrumental lofi, rain-textured ambient reset",
    "ambient ADHD music for focus and work, instrumental lofi, glass-rain reading pulse",
    "ambient ADHD music for focus and work, instrumental lofi, distant-storm low-distraction bed",
    "ambient ADHD music for focus and work, instrumental lofi, drizzle-coded task momentum",
    "ambient ADHD music for focus and work, instrumental lofi, afternoon-rain calm typing",
    "ambient ADHD music for focus and work, instrumental lofi, autumn-rain slow focus",
    # Late night city (16-30)
    "ambient ADHD music for focus and work, instrumental lofi, night-traffic concentration haze",
    "ambient ADHD music for focus and work, instrumental lofi, 3 AM quiet-task anchor",
    "ambient ADHD music for focus and work, instrumental lofi, late-study attention lamp",
    "ambient ADHD music for focus and work, instrumental lofi, city-night calm workflow",
    "ambient ADHD music for focus and work, instrumental lofi, midnight urban focus wash",
    "ambient ADHD music for focus and work, instrumental lofi, 2 AM soft deadline pulse",
    "ambient ADHD music for focus and work, instrumental lofi, neon-window steady thought",
    "ambient ADHD music for focus and work, instrumental lofi, night-drive planning groove",
    "ambient ADHD music for focus and work, instrumental lofi, quiet-city reading space",
    "ambient ADHD music for focus and work, instrumental lofi, jazz-lit task companion",
    "ambient ADHD music for focus and work, instrumental lofi, city-lights focus shimmer",
    "ambient ADHD music for focus and work, instrumental lofi, streetlamp work-session bed",
    "ambient ADHD music for focus and work, instrumental lofi, sleepless but gentle focus",
    "ambient ADHD music for focus and work, instrumental lofi, midnight-cafe calm output",
    "ambient ADHD music for focus and work, instrumental lofi, night-shift attention guide",
    # Piano-led (31-50)
    "ambient ADHD music for focus and work, instrumental lofi, felt-piano task clarity",
    "ambient ADHD music for focus and work, instrumental lofi, piano-ballad calm drafting",
    "ambient ADHD music for focus and work, instrumental lofi, piano-hop steady execution",
    "ambient ADHD music for focus and work, instrumental lofi, morning-keys work rhythm",
    "ambient ADHD music for focus and work, instrumental lofi, meditative piano focus lane",
    "ambient ADHD music for focus and work, instrumental lofi, cafe-piano attention pocket",
    "ambient ADHD music for focus and work, instrumental lofi, bedroom-keys calm build",
    "ambient ADHD music for focus and work, instrumental lofi, nocturne piano deep focus",
    "ambient ADHD music for focus and work, instrumental lofi, upright-piano clean workspace",
    "ambient ADHD music for focus and work, instrumental lofi, neo-classical task stillness",
    "ambient ADHD music for focus and work, instrumental lofi, rain-piano reading guide",
    "ambient ADHD music for focus and work, instrumental lofi, sketchbook piano momentum",
    "ambient ADHD music for focus and work, instrumental lofi, jazz-piano focus warmth",
    "ambient ADHD music for focus and work, instrumental lofi, sleepy-keys gentle productivity",
    "ambient ADHD music for focus and work, instrumental lofi, dawn-piano organized thought",
    "ambient ADHD music for focus and work, instrumental lofi, nostalgia-keys soft attention",
    "ambient ADHD music for focus and work, instrumental lofi, piano-pad sustained focus",
    "ambient ADHD music for focus and work, instrumental lofi, hip-hop keys task pulse",
    "ambient ADHD music for focus and work, instrumental lofi, delicate-keys quiet progress",
    "ambient ADHD music for focus and work, instrumental lofi, long-note piano focus rest",
    # Jazz-inflected (51-70)
    "ambient ADHD music for focus and work, instrumental lofi, jazz-room focus stability",
    "ambient ADHD music for focus and work, instrumental lofi, bossa-calm work cadence",
    "ambient ADHD music for focus and work, instrumental lofi, cool-jazz task balance",
    "ambient ADHD music for focus and work, instrumental lofi, Rhodes-jazz attention flow",
    "ambient ADHD music for focus and work, instrumental lofi, swing-soft typing groove",
    "ambient ADHD music for focus and work, instrumental lofi, late-jazz thought clearing",
    "ambient ADHD music for focus and work, instrumental lofi, trio-style work focus",
    "ambient ADHD music for focus and work, instrumental lofi, bebop-muted idea tracking",
    "ambient ADHD music for focus and work, instrumental lofi, jazz-ballad deep reading",
    "ambient ADHD music for focus and work, instrumental lofi, chillhop steady concentration",
    "ambient ADHD music for focus and work, instrumental lofi, trumpet-soft focus signal",
    "ambient ADHD music for focus and work, instrumental lofi, nocturne-jazz calm system",
    "ambient ADHD music for focus and work, instrumental lofi, sunny-jazz work clarity",
    "ambient ADHD music for focus and work, instrumental lofi, post-bop focused movement",
    "ambient ADHD music for focus and work, instrumental lofi, waltz-gentle task pacing",
    "ambient ADHD music for focus and work, instrumental lofi, impressionist calm attention",
    "ambient ADHD music for focus and work, instrumental lofi, vibraphone focus lantern",
    "ambient ADHD music for focus and work, instrumental lofi, jazz-lullaby work ease",
    "ambient ADHD music for focus and work, instrumental lofi, fusion-light focus groove",
    "ambient ADHD music for focus and work, instrumental lofi, standard-jazz calm review",
    # Dreamy / ambient pads (71-90)
    "ambient ADHD music for focus and work, instrumental lofi, pad-cloud attention blanket",
    "ambient ADHD music for focus and work, instrumental lofi, dreamscape task suspension",
    "ambient ADHD music for focus and work, instrumental lofi, soft-sub focus atmosphere",
    "ambient ADHD music for focus and work, instrumental lofi, cloud-hop calm productivity",
    "ambient ADHD music for focus and work, instrumental lofi, evolving-pad work tunnel",
    "ambient ADHD music for focus and work, instrumental lofi, space-pad quiet attention",
    "ambient ADHD music for focus and work, instrumental lofi, dream-lift focus wash",
    "ambient ADHD music for focus and work, instrumental lofi, meditation-pad desk calm",
    "ambient ADHD music for focus and work, instrumental lofi, vinyl-pad low-novelty focus",
    "ambient ADHD music for focus and work, instrumental lofi, suspended-pad task flow",
    "ambient ADHD music for focus and work, instrumental lofi, slow-dance work stillness",
    "ambient ADHD music for focus and work, instrumental lofi, deep-texture focus pool",
    "ambient ADHD music for focus and work, instrumental lofi, vapor-pad calm drafting",
    "ambient ADHD music for focus and work, instrumental lofi, soft-ambient work lift",
    "ambient ADHD music for focus and work, instrumental lofi, night-sky focus canopy",
    "ambient ADHD music for focus and work, instrumental lofi, soundscape task immersion",
    "ambient ADHD music for focus and work, instrumental lofi, warm-glow attention field",
    "ambient ADHD music for focus and work, instrumental lofi, lullaby-pad calm sorting",
    "ambient ADHD music for focus and work, instrumental lofi, wave-pad work reset",
    "ambient ADHD music for focus and work, instrumental lofi, journey-pad steady planning",
    # Study / focus (91-105)
    "ambient ADHD music for focus and work, instrumental lofi, study-session attention rail",
    "ambient ADHD music for focus and work, instrumental lofi, study-beat calm output",
    "ambient ADHD music for focus and work, instrumental lofi, exam-mode steady breathing",
    "ambient ADHD music for focus and work, instrumental lofi, library-desk focus hush",
    "ambient ADHD music for focus and work, instrumental lofi, productivity groove without rush",
    "ambient ADHD music for focus and work, instrumental lofi, midnight-study clean loop",
    "ambient ADHD music for focus and work, instrumental lofi, early-work gentle launch",
    "ambient ADHD music for focus and work, instrumental lofi, focus-flow task lock",
    "ambient ADHD music for focus and work, instrumental lofi, deep-work minimal anchor",
    "ambient ADHD music for focus and work, instrumental lofi, coding-focus smooth pulse",
    "ambient ADHD music for focus and work, instrumental lofi, study-cafe attention shelter",
    "ambient ADHD music for focus and work, instrumental lofi, creative-flow organized calm",
    "ambient ADHD music for focus and work, instrumental lofi, shuffle-soft focus meter",
    "ambient ADHD music for focus and work, instrumental lofi, writing-session quiet lane",
    "ambient ADHD music for focus and work, instrumental lofi, homework-task steady beat",
    # Nostalgic / tape (106-120)
    "ambient ADHD music for focus and work, instrumental lofi, vintage-tape attention warmth",
    "ambient ADHD music for focus and work, instrumental lofi, cassette-hiss work cocoon",
    "ambient ADHD music for focus and work, instrumental lofi, throwback calm task loop",
    "ambient ADHD music for focus and work, instrumental lofi, filtered-retro focus bed",
    "ambient ADHD music for focus and work, instrumental lofi, golden-era steady output",
    "ambient ADHD music for focus and work, instrumental lofi, bedroom-sampler calm focus",
    "ambient ADHD music for focus and work, instrumental lofi, nineties-Rhodes work flow",
    "ambient ADHD music for focus and work, instrumental lofi, old-cassette soft attention",
    "ambient ADHD music for focus and work, instrumental lofi, boom-bap low-distraction pulse",
    "ambient ADHD music for focus and work, instrumental lofi, time-machine focus warmth",
    "ambient ADHD music for focus and work, instrumental lofi, memory-tape calm thinking",
    "ambient ADHD music for focus and work, instrumental lofi, lost-tape task grounding",
    "ambient ADHD music for focus and work, instrumental lofi, record-shop work hum",
    "ambient ADHD music for focus and work, instrumental lofi, hip-hop-roots focus nod",
    "ambient ADHD music for focus and work, instrumental lofi, archive-warm attention loop",
    # Nature / outdoor (121-135)
    "ambient ADHD music for focus and work, instrumental lofi, forest-air task clarity",
    "ambient ADHD music for focus and work, instrumental lofi, morning-dew focus quiet",
    "ambient ADHD music for focus and work, instrumental lofi, creekside work rhythm",
    "ambient ADHD music for focus and work, instrumental lofi, open-air attention space",
    "ambient ADHD music for focus and work, instrumental lofi, autumn-leaf calm review",
    "ambient ADHD music for focus and work, instrumental lofi, ocean-breath focus bed",
    "ambient ADHD music for focus and work, instrumental lofi, mountain-air work stillness",
    "ambient ADHD music for focus and work, instrumental lofi, garden-desk focus warmth",
    "ambient ADHD music for focus and work, instrumental lofi, campfire-soft task anchor",
    "ambient ADHD music for focus and work, instrumental lofi, meadow-light attention flow",
    "ambient ADHD music for focus and work, instrumental lofi, seaside-calm work pacing",
    "ambient ADHD music for focus and work, instrumental lofi, forest-floor deep focus",
    "ambient ADHD music for focus and work, instrumental lofi, sunrise-nature task lift",
    "ambient ADHD music for focus and work, instrumental lofi, countryside quiet productivity",
    "ambient ADHD music for focus and work, instrumental lofi, blossom-light focus ease",
    # Melancholy / emotional (136-155)
    "ambient ADHD music for focus and work, instrumental lofi, melancholy-focus soft container",
    "ambient ADHD music for focus and work, instrumental lofi, grief-wave calm grounding",
    "ambient ADHD music for focus and work, instrumental lofi, 4 AM work-stillness pad",
    "ambient ADHD music for focus and work, instrumental lofi, bittersweet attention balance",
    "ambient ADHD music for focus and work, instrumental lofi, yearning-soft task thread",
    "ambient ADHD music for focus and work, instrumental lofi, heartbreak-muted focus room",
    "ambient ADHD music for focus and work, instrumental lofi, missing-someone calm work",
    "ambient ADHD music for focus and work, instrumental lofi, tender-note attention hold",
    "ambient ADHD music for focus and work, instrumental lofi, sunset-end task release",
    "ambient ADHD music for focus and work, instrumental lofi, reflective-regret focus wash",
    "ambient ADHD music for focus and work, instrumental lofi, empty-house quiet output",
    "ambient ADHD music for focus and work, instrumental lofi, letter-writing task pulse",
    "ambient ADHD music for focus and work, instrumental lofi, midnight-catharsis calm focus",
    "ambient ADHD music for focus and work, instrumental lofi, holding-on steady work",
    "ambient ADHD music for focus and work, instrumental lofi, departure-soft attention drift",
    "ambient ADHD music for focus and work, instrumental lofi, growing-up focus memory",
    "ambient ADHD music for focus and work, instrumental lofi, afterglow task stillness",
    "ambient ADHD music for focus and work, instrumental lofi, winter-inside calm desk",
    "ambient ADHD music for focus and work, instrumental lofi, long-way-home work flow",
    "ambient ADHD music for focus and work, instrumental lofi, letting-go focus ease",
    # Cozy / home (156-170)
    "ambient ADHD music for focus and work, instrumental lofi, cozy-room productivity glow",
    "ambient ADHD music for focus and work, instrumental lofi, blanket-soft attention pad",
    "ambient ADHD music for focus and work, instrumental lofi, hot-chocolate task warmth",
    "ambient ADHD music for focus and work, instrumental lofi, weekend-morning work calm",
    "ambient ADHD music for focus and work, instrumental lofi, home-studio focus pocket",
    "ambient ADHD music for focus and work, instrumental lofi, kitchen-light task rhythm",
    "ambient ADHD music for focus and work, instrumental lofi, sofa-session calm focus",
    "ambient ADHD music for focus and work, instrumental lofi, drowsy-piano work rest",
    "ambient ADHD music for focus and work, instrumental lofi, afternoon-tea attention ease",
    "ambient ADHD music for focus and work, instrumental lofi, reading-nook focus quiet",
    "ambient ADHD music for focus and work, instrumental lofi, Sunday-slow task drift",
    "ambient ADHD music for focus and work, instrumental lofi, golden-lamp work clarity",
    "ambient ADHD music for focus and work, instrumental lofi, sweater-weather focus comfort",
    "ambient ADHD music for focus and work, instrumental lofi, fireplace-calm productivity",
    "ambient ADHD music for focus and work, instrumental lofi, gentle-embrace attention bed",
    # Space / cosmic (171-180)
    "ambient ADHD music for focus and work, instrumental lofi, orbital-focus deep space",
    "ambient ADHD music for focus and work, instrumental lofi, cosmos-calm work drift",
    "ambient ADHD music for focus and work, instrumental lofi, deep-space attention field",
    "ambient ADHD music for focus and work, instrumental lofi, nebula-soft task immersion",
    "ambient ADHD music for focus and work, instrumental lofi, telescope-night focus lane",
    "ambient ADHD music for focus and work, instrumental lofi, lunar-desk work stillness",
    "ambient ADHD music for focus and work, instrumental lofi, aurora-focus shimmer",
    "ambient ADHD music for focus and work, instrumental lofi, satellite-signal attention loop",
    "ambient ADHD music for focus and work, instrumental lofi, wormhole-calm planning",
    "ambient ADHD music for focus and work, instrumental lofi, event-horizon deep focus",
    # Morning / light (181-190)
    "ambient ADHD music for focus and work, instrumental lofi, golden-morning task lift",
    "ambient ADHD music for focus and work, instrumental lofi, first-light focus start",
    "ambient ADHD music for focus and work, instrumental lofi, 6 AM calm work pad",
    "ambient ADHD music for focus and work, instrumental lofi, coffee-soft attention wake",
    "ambient ADHD music for focus and work, instrumental lofi, breakfast-table task rhythm",
    "ambient ADHD music for focus and work, instrumental lofi, window-light focus lane",
    "ambient ADHD music for focus and work, instrumental lofi, garden-morning work clarity",
    "ambient ADHD music for focus and work, instrumental lofi, Sunday-morning calm focus",
    "ambient ADHD music for focus and work, instrumental lofi, dawn-rising task flow",
    "ambient ADHD music for focus and work, instrumental lofi, honey-light attention glow",
    # Slowed / reverbed (191-200)
    "ambient ADHD music for focus and work, instrumental lofi, slowed-reverb deep task bed",
    "ambient ADHD music for focus and work, instrumental lofi, Rhodes-slow calm concentration",
    "ambient ADHD music for focus and work, instrumental lofi, reverb-drenched focus cloud",
    "ambient ADHD music for focus and work, instrumental lofi, slowed-sad work cushion",
    "ambient ADHD music for focus and work, instrumental lofi, drowned-piano attention wash",
    "ambient ADHD music for focus and work, instrumental lofi, nostalgic-slow task memory",
    "ambient ADHD music for focus and work, instrumental lofi, reverb-cloud focus shelter",
    "ambient ADHD music for focus and work, instrumental lofi, slow-motion work stillness",
    "ambient ADHD music for focus and work, instrumental lofi, tape-drag attention anchor",
    "ambient ADHD music for focus and work, instrumental lofi, endless-reverb calm output",
)

if len(_ADHD_FOCUS_PROMPT_OPENERS) != len(_BASE_LOFI_PROMPT_BANK):
    raise RuntimeError("ADHD focus openers must match the 200-prompt lofi bank.")

LOFI_PROMPT_BANK: tuple[str, ...] = tuple(
    f"{focus_opening}, {prompt}"
    for focus_opening, prompt in zip(_ADHD_FOCUS_PROMPT_OPENERS, _BASE_LOFI_PROMPT_BANK)
)
